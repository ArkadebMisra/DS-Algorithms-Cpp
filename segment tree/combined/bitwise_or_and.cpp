...
// apply the operation ai=ai|v (bitwise OR) to all elements from l to r−1
// find bitwise AND of elements in the range from l to r−1.

//link to the problem  https://codeforces.com/edu/course/2/lesson/5/2/practice/contest/279653/problem/C
